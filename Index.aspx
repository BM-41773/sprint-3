...
<body>
    ...
    <tr><td>
       <input type="text" name="x_username" class="username" /><% Html.TextBox("x_username")%>
            ...
            <input type="submit" id="login" value="login" onclick="return login_onclick()" /><%  End Using%></td></tr>
                <tr><td>
    ...
    <tr><td><input type="text" placeholder="First name" style="width:190px; height:30px;" />&nbsp;&nbsp;&nbsp;<input  type="text" placeholder="Surname" style="width:190px; height:30px;"/>
          </td> </tr>
            <tr> <td>
               <input type="text" placeholder="email or Phone" style="width:290px; height:30px;" /></td></tr>
               
                    <tr><td>
                       <input type="password" placeholder="password" style="width:290px; height:30px;" /></td></tr>
